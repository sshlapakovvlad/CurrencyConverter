...
class RoomUserCurrencySelectionLocalService(private val roomUserCurrencySelectionDatabase: RoomUserCurrencySelectionDatabase) :
    UserCurrencySelectionLocalService {
